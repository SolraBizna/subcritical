...
if(osc == "other") then
   ...
   local platforms = {
      ...
      darwin={cxx="g++ -Wall -Werror -Wno-pmf-conversions -O2 -fPIC -fno-common -c", ld="MACOSX_DEPLOYMENT_TARGET=\"10.3\" g++ -bundle -undefined dynamic_lookup -Wl,-bind_at_load", soext=".so"},
   }
